...
public class OrderListener {
    ...
    @RabbitHandler
    public void orderPaySuccessListener(Message message, Channel channel) throws Exception {
        ...
        // 逻辑处理
        // 判断是否已经处理过
        Transaction transaction = transactionService.getById(String.valueOf(id));
        if (transaction != null) {
        ...
        // 插入事务表
        transaction = new Transaction().setTransactionId(String.valueOf(id)).setStatus(1);
